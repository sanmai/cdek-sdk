...
Перед вами полное SDK для [интеграции с программным комплексом СДЭК](https://cdek.ru/integration) с открытым [исходным кодом](https://github.com/sanmai/cdek-sdk).
